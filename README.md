...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=32&duration=2000&pause=1000&color=E59F32&center=true&vCenter=true&width=700&lines=Software+Engineer+%F0%9F%92%BB;Health+Informatics+Specialist+%F0%9F%A9%BA;Data+Scientist+%F0%9F%93%8A;Digital+Health+Innovator+%F0%9F%9A%80" alt="Typing SVG" />
</div>
...
timeline
    ...
    2022 : Commenced BSc. Health Records & Informatics @ JKUAT
    2024 : Health Informatics Residency | Naivasha Sub-County Referral Hospital
         : - Streamlined ICD-11 coding accuracy and optimized KHIS reporting architectures.
    2025 : Advanced Informatics Residency | Naivasha Sub-County Referral Hospital
         : - Spearheaded ML-driven predictive analytics and engineered 30% system workflow efficiencies.
    2026 : Active Focus | Scaling production software ventures, cryptographic tools, & cloud architectures.
    2027 : Milestone | Graduation & Enterprise Technology Leadership.
...
```mermaid
graph TD
    A[Advanced Machine Learning] --> B[Clinical Deep Learning Systems]
    B --> C[AI Diagnostic Engines]
    
    D[Decentralized Finance] --> E[Cryptographic Security Frameworks]
    E --> F[Secure, Distributed Infrastructure]
    
    G[Cloud Native Architecture] --> H[Highly Scalable Platforms]
    H --> I[Enterprise Software Deployments]

    style C fill:#E59F32,stroke:#000,stroke-width:2px
    style F fill:#E59F32,stroke:#000,stroke-width:2px
    style I fill:#E59F32,stroke:#000,stroke-width:2px
